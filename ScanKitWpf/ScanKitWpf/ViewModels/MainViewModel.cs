...
namespace ScanKitWpf.ViewModels
{
    ...
    public class MainViewModel : Screen
    {
        ...
        private void AnalyseCode()
        {
            ...
            HOperatorSet.MedianImage(ho_ImageScaled, out ho_ImageMedian, "circle", 2, "mirrored");
